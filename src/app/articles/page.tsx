    ...
    <main className="flex w-full h-screen shadow-lg rounded-3xl bg-white text-primary">
      ...
      >
        ...
        <Link
          ...
          about="Create Article"
          title="Create Article"
          className="flex items-center justify-center bg-secondary text-primary w-fit h-fit text-[3rem] p-2 font-semibold rounded-full absolute right-10 bottom-10 cursor-pointer hover:bg-primary hover:text-white duration-700 transition-all"
        >
